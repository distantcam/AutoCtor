...
internal static class Diagnostics
{
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor AmbiguousMarkedPostConstructMethod = new(
        id: "ACTR001",
        title: "Ambiguous marked post constructor method",
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor PostConstructMethodNotVoid = new(
        id: "ACTR002",
        title: "Post construct method must return void",
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor PostConstructMethodCannotBeGeneric = new(
        id: "ACTR004",
        title: "Post construct method must not be generic",
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor PostConstructOutParameterCannotBeKeyed = new(
        id: "ACTR005",
        title: "Post construct out or ref parameter must not be a keyed service",
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor PostConstructOutParameterMustNotMatchKeyedField = new(
        id: "ACTR006",
        title: "Post construct out or ref parameter must not match a keyed field",
